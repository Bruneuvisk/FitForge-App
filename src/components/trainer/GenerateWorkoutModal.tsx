...
export function GenerateWorkoutModal({ client, onClose, onGenerated }: GenerateWorkoutModalProps) {
      ...
      <div className="bg-white rounded-2xl max-w-md w-full">
        <div className="p-6 border-b border-gray-200 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Gerar Treino com IA</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 mb-6">
            Nossa IA vai criar um plano de treino personalizado para{' '}
            <span className="font-semibold text-gray-900">
              {client.profiles?.full_name}
            </span>{' '}
            baseado em suas características e objetivos.
          </p>

          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 mb-6">
            <h3 className="font-semibold text-emerald-900 mb-2">Informações do Cliente:</h3>
